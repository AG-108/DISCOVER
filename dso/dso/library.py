...
class Library:
    ...
    def __init__(self, tokens):
        ...
        self.non_state_tokens = np.array(
            [i for i, t in enumerate(self.tokens) if t.arity == 0 and t.state_var is None],
            dtype=np.int32)
    ...
    def add_subgrid_tokens(self, tokens):
        self.subgrid_tokens = tokens
